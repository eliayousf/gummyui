...
The current public source is `en-72e701f4add4`. The private workflow already
...
npm run localisation:private-review -- \
  --draft ../gummyui-pro/localisation/drafts/en-72e701f4add4/fr.draft.json \
  --quality ../gummyui-pro/localisation/quality/en-72e701f4add4/fr.quality.json
```

The output is:

```text
work/localisation-reviews/en-72e701f4add4/fr.review.html
```
