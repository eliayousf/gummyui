...
const componentUsageGuidance = {
  ...
  badge:
    "Use a badge for a short, stable status or classification that helps someone scan nearby content. Write the meaning in text rather than relying on colour, shape, or position, and avoid making a non-interactive status look like a button. Decide how urgent changes are announced separately from the visual token. Test long translations, repeated states in dense lists, forced colours, dark mode, zoom, and values that update after the page loads.",
  breadcrumb:
